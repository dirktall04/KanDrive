...
'''
try:
    from config import sdeCDRS, sdeCDRSWZ, sdeKandriveConstruction# @UnresolvedImport
except:
    ...
    sdeCDRSWZ = r"D:\kandrive\harvesters\scheduled-tasks\kanroad@krprod.sde\KANROAD.CDRS_WZ_DETAIL"
    sdeKandriveConstruction = r"D:\kandrive\harvesters\scheduled-tasks\geo_admin@KanDrive_Spatial_Prod.sde\kandrive_spatial.DBO.Construction"
'''

sdeCDRS = r"D:\kandrive\harvesters\scheduled-tasks\KRPublic.sde\KANROAD.CDRS_ALERT_ROUTE"
sdeCDRSWZ = r"D:\kandrive\harvesters\scheduled-tasks\KRPublic.sde\KANROAD.CDRS_WZ_DETAIL"
sdeKandriveConstruction = r"D:\kandrive\harvesters\scheduled-tasks\geo_admin@KanDrive_Spatial_Prod.sde\kandrive_spatial.DBO.Construction"
...
def RemoveGpHistory_fc(out_xml):
    ...
    try:
        name_xml = "Kandrive_Construction_Update.xml"
        #Process: XSLT Transformation
        XSLTransform_conversion(sdeKandriveConstruction, remove_gp_history_xslt, name_xml, "")
        #print "Completed xml conversion on {0}".format(sdeKandriveConstruction)
        # Process: Metadata Importer
        MetadataImporter_conversion(name_xml,sdeKandriveConstruction)
        #print "Imported XML on {0}".format(sdeKandriveConstruction)
    except:
        print "could not complete xml conversion on {0}".format(sdeKandriveConstruction)
        pass
...
if __name__== "__main__":
    ...
    print "Kandrive_Construction_Update script imported."